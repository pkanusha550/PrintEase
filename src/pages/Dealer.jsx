                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        {order.statusKey === 'dealer-accepted' && (
                          <Button
                            variant="primary"
                            size="sm"
                            onClick={() => handleUpdateStatus(order.id, 'Printing Started', 'printing-started')}
                          >
                            Start Printing
                          </Button>
                        )}
                        {order.statusKey === 'printing-started' && (
                          <Button
                            variant="primary"
                            size="sm"
                            onClick={() => handleUpdateStatus(order.id, 'Printing Completed', 'printing-completed')}
                          >
                            Complete Printing
                          </Button>
                        )}
                          ...
                          <>
                            {order.orderData?.deliveryMethod === 'Delivery' ? (
                              <Button
                                variant="primary"
                                size="sm"
                                onClick={() => handleUpdateStatus(order.id, 'Out for Delivery', 'out-for-delivery')}
                              >
                                Out for Delivery
                              </Button>
                            ) : (
                              <Button
                                variant="primary"
                                size="sm"
                                onClick={() => handleUpdateStatus(order.id, 'Ready for Pickup', 'ready-for-pickup')}
                              >
                                Ready for Pickup
                              </Button>
                            )}
                        ...
                        {(order.statusKey === 'out-for-delivery' || order.statusKey === 'ready-for-pickup') && (
                          <Button
                            variant="primary"
                            size="sm"
