...
import { Clock, CheckCircle, XCircle, Package, MapPin, Eye, ChevronDown, ChevronUp, Layers, MessageCircle } from 'lucide-react';
...
const statusConfig = {
  pending: { icon: Clock, color: 'text-primary bg-primary-light', label: 'Pending' },
